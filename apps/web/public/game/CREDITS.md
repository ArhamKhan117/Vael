...
`apps/web/public/badges/level-1.png` through `level-10.png` are generated by
`apps/web/scripts/make-badges.mjs`, which crops item tiles out of the Kenney Tiny Dungeon sheet and
composites them onto a plaque.
CC0 permits this without condition; the pack is credited above regardless.
