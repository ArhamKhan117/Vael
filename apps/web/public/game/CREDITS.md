...
| `apps/web/public/quests/daily-portal.png` | gpt-image-2.5-flare | A small violet portal ring glowing at dawn on a quiet stone terrace, a single lantern beside it, mist on the ground, the first light of morning behind. Calm and inviting. No figures, no text. |
| `apps/web/public/quests/daily-transfer.png` | gpt-image-2.5-flare | A glowing emerald coin passing from one open stone hand to another across a dark table, a thin trail of green light between them. Warm focused light. No faces, no text. |
| `apps/web/public/quests/daily-wrap.png` | gpt-image-2.5-flare | A violet coin settling into an open crystal casket on a dark workbench, the lid tilted up, soft violet glow spilling over the wood. No figures, no text. |
| `apps/web/public/quests/weekly-swap.png` | gpt-image-2.5-flare | A grand circular trading floor of dark stone under a domed roof, two enormous sky-blue coins arcing past each other high above it, light trails crossing. No figures, no text. |
| `apps/web/public/quests/weekly-supply.png` | gpt-image-2.5-flare | A deep indigo reservoir of glowing light sunk into a dark vault floor, a steady stream of coins falling into it from a high opening, ripples spreading. No figures, no text. |
| `apps/web/public/quests/partner-penguin.png` | gpt-image-2.5-flare | A trading post carved into a wall of glowing blue ice, lanterns along its front, two cyan coins hovering above the counter mid trade, cold mist at the floor. No animals, no figures, no text. |
| `apps/web/public/quests/partner-checkin.png` | gpt-image-2.5-flare | A tall golden archway standing alone on dark polished stone, a warm beam of light falling through it onto a single glowing mark on the floor. No figures, no text. |
| `apps/web/public/quests/open-borrow.png` | gpt-image-2.5-flare | An open stone vault with warm amber coins streaming out and up into the dark, a heavy chain hanging slack beside the door. No figures, no text. |
| `apps/web/public/quests/open-swap.png` | gpt-image-2.5-flare | Two luminous coins, one sky blue and one pale silver, crossing paths above a dark reflective floor in a narrow shaft of light. No figures, no text. |
| `apps/web/public/items/rusted-blade.png` | gpt-image-2.5-flare | A short pitted iron sword with a rust-stained blade and a worn leather grip, floating upright against a dark background, dim cold light along the edge. Single object, centred, nothing else in frame. |
| `apps/web/public/items/padded-vest.png` | gpt-image-2.5-flare | A quilted brown padded cloth vest with simple stitching and a plain buckle, floating upright against a dark background, soft warm light. Single object, centred, nothing else in frame. |
| `apps/web/public/items/iron-sword.png` | gpt-image-2.5-flare | A clean straight iron longsword with a polished blade, plain crossguard and dark wrapped grip, floating upright against a dark background, cool steel highlights. Single object, centred, nothing else in frame. |
| `apps/web/public/items/swift-charm.png` | gpt-image-2.5-flare | A small teal gemstone charm shaped like a feather on a fine silver chain, floating against a dark background, a faint trail of light suggesting speed. Single object, centred, nothing else in frame. |
| `apps/web/public/items/plate-harness.png` | gpt-image-2.5-flare | A steel plate cuirass with blue enamel trim and engraved shoulders, floating upright against a dark background, cool rim light along the edges. Single object, centred, nothing else in frame. |
| `apps/web/public/items/scholars-scroll.png` | gpt-image-2.5-flare | A half-unrolled parchment scroll with glowing blue abstract marks and brass end caps, floating against a dark background, soft blue light from the marks. Abstract marks only, no readable letters. Single object, centred. |
| `apps/web/public/items/arcane-codex.png` | gpt-image-2.5-flare | A thick leather-bound tome lying open in mid air, violet light pouring up from its pages, a brass clasp hanging loose, against a dark background. No readable letters. Single object, centred. |
| `apps/web/public/items/warhammer.png` | gpt-image-2.5-flare | A massive two-handed war hammer with a blunt iron head and a banded oak haft, floating upright against a dark background, heavy warm light on the metal. Single object, centred, nothing else in frame. |
| `apps/web/public/items/gilded-aegis.png` | gpt-image-2.5-flare | An ornate golden tower shield with filigree edging and a domed boss, floating upright against a dark background, rich warm gold light. Single object, centred, no emblem, no crest, nothing else in frame. |
| `apps/web/public/items/blessed-blade.png` | gpt-image-2.5-flare | A radiant longsword with a pale white-gold blade wreathed in soft holy light, an elegant winged crossguard, floating upright against a dark background. Single object, centred, nothing else in frame. |
| `apps/web/public/items/seers-crystal.png` | gpt-image-2.5-flare | A large faceted violet crystal orb hovering above a small dark stand, deep light swirling inside it, faint motes drifting around, against a dark background. Single object, centred, nothing else in frame. |
<!-- generated-art:end -->
