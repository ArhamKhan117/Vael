...
async function main() {
  // The catalogue only, by default. The item artwork under apps/web/public/items is generated by
  // apps/api/scripts/generate-art.ts now, and this script's plate-and-icon composites would
